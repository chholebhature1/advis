...
begin
  ...
  values (
    ...
    coalesce(nullif(p_payload ->> 'section_80d_used_inr', '')::numeric, 0),
    coalesce(nullif(p_payload ->> 'home_loan_interest_inr', '')::numeric, 0)
  )
  ...
  set
    ...
    section_80d_used_inr = excluded.section_80d_used_inr,
    home_loan_interest_inr = excluded.home_loan_interest_inr,
