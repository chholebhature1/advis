    ...
    fields: [
      {
        ...
        label: "Choose your monthly range",
        type: "choice",
        required: true,
        options: [
    ...
    fields: [
      {
        ...
        required: true,
        options: [
          { label: "Below ₹25,000", value: "below_25000" },
          { label: "₹25,000 – ₹50,000", value: "25000_50000" },
          { label: "₹50,000 – ₹1 Lakh", value: "50000_100000" },
          { label: "₹1 Lakh – ₹3 Lakh", value: "100000_300000" },
          { label: "₹3 Lakh+", value: "300000_plus" },
        ],
